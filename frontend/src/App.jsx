...
export default function App() {
  ...
  const headline = useMemo(() => {
    if (activeTab === "profile") return "Professional profile view with career activity highlights";
    ...
    if (activeTab === "activity") return "Measure consistency and dedication across your job search";
